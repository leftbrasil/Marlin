...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp  31.82
    #define DEFAULT_Ki   2.93
    #define DEFAULT_Kd  86.56
  #endif
#else
 ...
 */
  ...
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 81, 82, 408.91, 420 }
  #endif
#else
  #ifdef IS_2D
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.1  // tuned for 1500 accelerations // (mm) Distance from real junction edge
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 113, 30 }
